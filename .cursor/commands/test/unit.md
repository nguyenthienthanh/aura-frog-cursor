# /test:unit - Add unit tests to achieve target coverage  

## Description

Add unit tests to achieve target coverage  

**Original command:** `test:unit`
...
- Original Aura Frog command: `test:unit`
