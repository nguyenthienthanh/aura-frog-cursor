# /bugfix:hotfix - Emergency production bug fix (fastest workflow)

## Description

Emergency production bug fix (fastest workflow)

**Original command:** `bugfix:hotfix`

## Usage

```
/bugfix:hotfix [arguments]
```
...
- Original Aura Frog command: `bugfix:hotfix`
