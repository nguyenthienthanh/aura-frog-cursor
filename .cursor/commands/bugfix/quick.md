# /bugfix:quick - Quick bug fix for obvious issues (simplified workflow)

## Description

Quick bug fix for obvious issues (simplified workflow)

**Original command:** `bugfix:quick`

## Usage

```
/bugfix:quick [arguments]
```
...
- Original Aura Frog command: `bugfix:quick`
