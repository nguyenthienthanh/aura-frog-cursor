# /workflow:handoff - Prepare workflow for continuation in new session  

## Description

Prepare workflow for continuation in new session  

**Original command:** `workflow:handoff`

## Usage

```
/workflow:handoff [arguments]
```
...
- Original Aura Frog command: `workflow:handoff`
