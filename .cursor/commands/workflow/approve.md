# /workflow:approve - Approve current phase and proceed to next phase  

## Description

Approve current phase and proceed to next phase  

**Original command:** `workflow:approve`

## Usage

```
/workflow:approve [arguments]
```
...
- Original Aura Frog command: `workflow:approve`
