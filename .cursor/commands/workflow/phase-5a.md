# /workflow:phase-5a - Execute Phase 5a - Write Tests (RED Phase of TDD)  

## Description

Execute Phase 5a - Write Tests (RED Phase of TDD)  

**Original command:** `workflow:phase:5a`

## Usage

```
/workflow:phase-5a [arguments]
```
...
- Original Aura Frog command: `workflow:phase:5a`
