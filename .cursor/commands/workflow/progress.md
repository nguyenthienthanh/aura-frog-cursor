# /workflow:progress - Show workflow progress and timeline  

## Description

Show workflow progress and timeline  

**Original command:** `workflow:progress`

## Usage

```
/workflow:progress [arguments]
```
...
- Original Aura Frog command: `workflow:progress`
