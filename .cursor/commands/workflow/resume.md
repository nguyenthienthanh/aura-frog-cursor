# /workflow:resume - Resume workflow from previous session  

## Description

Resume workflow from previous session  

**Original command:** `workflow:resume`

## Usage

```
/workflow:resume [arguments]
```
...
- Original Aura Frog command: `workflow:resume`
