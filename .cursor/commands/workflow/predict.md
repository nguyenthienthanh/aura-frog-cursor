# /workflow:predict - Predict token usage for a workflow before starting

## Description

Predict token usage for a workflow before starting

**Original command:** `workflow:predict`

## Usage

```
/workflow:predict [arguments]
```
...
- Original Aura Frog command: `workflow:predict`
