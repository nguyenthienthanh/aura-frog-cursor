# /workflow:status - Display current workflow status and progress  

## Description

Display current workflow status and progress  

**Original command:** `workflow:status`

## Usage

```
/workflow:status [arguments]
```
...
- Original Aura Frog command: `workflow:status`
