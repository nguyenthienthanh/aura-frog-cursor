# /workflow:metrics - Display workflow quality and performance metrics  

## Description

Display workflow quality and performance metrics  

**Original command:** `workflow:metrics`

## Usage

```
/workflow:metrics [arguments]
```
...
- Original Aura Frog command: `workflow:metrics`
