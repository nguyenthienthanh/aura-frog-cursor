# /workflow:tokens - Display token usage for current workflow  

## Description

Display token usage for current workflow  

**Original command:** `workflow:tokens`

## Usage

```
/workflow:tokens [arguments]
```
...
- Original Aura Frog command: `workflow:tokens`
