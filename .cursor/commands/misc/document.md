# /misc:document - Create feature documentation (specs, guides, API docs)  

## Description

Create feature documentation (specs, guides, API docs)  
...
- Original Aura Frog command: `document`
